class MessageType:
    ...
    # Replicación de operaciones de directorios y eliminación
    DATA_REPLICATE_DIR_CREATE = "DATA_REPLICATE_DIR_CREATE"
    DATA_REPLICATE_DIR_DELETE = "DATA_REPLICATE_DIR_DELETE"
    DATA_REPLICATE_FILE_DELETE = "DATA_REPLICATE_FILE_DELETE"
    DATA_REPLICATE_RENAME = "DATA_REPLICATE_RENAME"
