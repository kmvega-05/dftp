...
logger = logging.getLogger("dftp.processing.handlers.cdup")

def handle_cdup(cmd: Command, data: dict = None, processing_node = None) -> tuple[int, str, dict]:
    """Maneja el comando CDUP."""

    if not cmd.require_args(0):
        return 501, "Syntax error in parameters. Usage: CDUP", None
